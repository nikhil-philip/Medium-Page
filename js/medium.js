...
//on hover popup
const onHoverLink=document.querySelector('.onHover');
const onHoverPopup=document.getElementById('popup');
onHoverLink.onmouseenter=function(){
  onHoverPopup.classList.remove('hidden');
};
onHoverLink.onfocus=function(){
  onHoverPopup.classList.remove('hidden');
};
